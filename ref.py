...
def main():
    ...
    logger.info("Starting Time-Traveling Research Companion")
    ...
    try:
        ...
        try:
            ...
            logger.error(f"Error launching Gradio interface: {launch_error}", exc_info=True)
    
    except Exception as setup_error:
        logger.error(f"Critical error setting up the application: {setup_error}", exc_info=True)
